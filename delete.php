        ...
        if (isset($_SESSION["useruid"])) {
          ...
          while ($row = mysqli_fetch_assoc($result))
            ...
            
            {
              ...
              <td valign = 'top' width = '$eightzero%'; style = 'text-align:left'>&nbsp;Inlagd: " . $row["timestamp"]. " - Namn: " . $row["first_name"]. " " . $row["last_name"]. ",
              
              ålder " . $row["age"]. ", ort: " . $row["location"] . ", gender: " . $row["gender"] .", ålänning: " . $row["ålänning"] . "<br>
              
              <p style = 'text-align:center'><a href='delete_process.php?id=" . $row['user_Id'] . " '>Delete</a></p><br><br></td></tr></tbody></table>";
